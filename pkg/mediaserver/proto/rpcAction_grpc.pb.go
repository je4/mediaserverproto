...
type ActionClient interface {
	...
	GetParams(ctx context.Context, in *ParamsParam, opts ...grpc.CallOption) (*StringListMap, error)
...
func (c *actionClient) GetParams(ctx context.Context, in *ParamsParam, opts ...grpc.CallOption) (*StringListMap, error) {
	out := new(StringListMap)
...
type ActionServer interface {
	...
	GetParams(context.Context, *ParamsParam) (*StringListMap, error)
...
func (UnimplementedActionServer) GetParams(context.Context, *ParamsParam) (*StringListMap, error) {

...
var file_action_proto_rawDesc = []byte{
	...
	0x5f, 0x68, 0x6f, 0x73, 0x74, 0x22, 0xa5, 0x01, 0x0a, 0x09, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	,
	...
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0xa2, 0x02, 0x03, 0x55,
	0x42, 0x42, 0xaa, 0x02, 0x15, 0x55, 0x6e, 0x69, 0x62, 0x61, 0x73, 0x2e, 0x55, 0x42, 0x2e, 0x4d,
	0x65, 0x64, 0x69, 0x61, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_action_proto_goTypes = []interface{}{
	...
	(*ActionResponse)(nil),                  // 3: mediaserverproto.ActionResponse
	(*ActionDispatcherParam)(nil),           // 4: mediaserverproto.ActionDispatcherParam
	(*ActionMap)(nil),                       // 5: mediaserverproto.ActionMap
	nil,                                     // 6: mediaserverproto.ActionParam.ParamsEntry
	nil,                                     // 7: mediaserverproto.ActionDispatcherParam.ActionsEntry
	nil,                                     // 8: mediaserverproto.ActionMap.ActionsEntry
	(*Item)(nil),                            // 9: mediaserverproto.Item
	(*Storage)(nil),                         // 10: mediaserverproto.Storage
	(*proto.DefaultResponse)(nil),           // 11: genericproto.DefaultResponse
	(*Cache)(nil),                           // 12: mediaserverproto.Cache
	(*proto.StringList)(nil),                // 13: genericproto.StringList
}
var file_action_proto_depIdxs = []int32{
	9,  // 0: mediaserverproto.ActionParam.item:type_name -> mediaserverproto.Item
	6,  // 1: mediaserverproto.ActionParam.params:type_name -> mediaserverproto.ActionParam.ParamsEntry
	10, // 2: mediaserverproto.ActionParam.storage:type_name -> mediaserverproto.Storage
	11, // 3: mediaserverproto.ActionDispatcherDefaultResponse.response:type_name -> genericproto.DefaultResponse
	11, // 4: mediaserverproto.ActionResponse.response:type_name -> genericproto.DefaultResponse
	12, // 5: mediaserverproto.ActionResponse.cache:type_name -> mediaserverproto.Cache
	7,  // 6: mediaserverproto.ActionDispatcherParam.actions:type_name -> mediaserverproto.ActionDispatcherParam.ActionsEntry
	8,  // 7: mediaserverproto.ActionMap.actions:type_name -> mediaserverproto.ActionMap.ActionsEntry
	13, // 8: mediaserverproto.ActionDispatcherParam.ActionsEntry.value:type_name -> genericproto.StringList
	13, // 9: mediaserverproto.ActionMap.ActionsEntry.value:type_name -> genericproto.StringList
